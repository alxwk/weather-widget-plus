...
var WeatherFont = {
    ...
    // https://open-meteo.com/en/docs <- bottom of page, +1 for json string problem
    iconNameByOmCode: {
        ...
        '46': ['wi-fog', 'wi-fog'],
        '49': ['wi-dust', 'wi-dust'],
        '52': ['wi-day-sprinkle', 'wi-night-sprinkle'],
        '54': ['wi-sprinkle', 'wi-sprinkle'],
        '56': ['wi-sprinkle', 'wi-sprinkle'],
        '57': ['wi-day-rain-mix', 'wi-night-rain-mix'],
        '58': ['wi-rain-mix', 'wi-rain-mix'],
        '62': ['wi-day-rain', 'wi-night-rain'],
        '64': ['wi-rain', 'wi-rain'],
        '66': ['wi-rain', 'wi-rain'],
        '67': ['wi-day-rain-mix', 'wi-night-rain-mix'],
        '68': ['wi-rain-mix', 'wi-rain-mix'],
        '72': ['wi-day-snow', 'wi-night-snow'],
        '74': ['wi-snow', 'wi-snow'],
        '76': ['wi-snow-heavy', 'wi-snow-heavy'],
        '78': ['wi-snowflake-cold', 'wi-snowflake-cold'],
        '81': ['wi-day-showers', 'wi-night-showers'],
        '82': ['wi-showers', 'wi-showers'],
        '83': ['wi-showers', 'wi-showers'],
        '86': ['wi-day-snow', 'wi-night-snow'],
        '87': ['wi-snow-heavy', 'wi-snow-heavy'],
        '96': ['wi-thunderstorm', 'wi-thunderstorm'],
        '97': ['wi-day-snow-thunderstorm', 'wi-night-snow-thunderstorm'],
        '100': ['wi-storm-showers', 'wi-storm-showers'],
        '1000': ['wi-na', 'wi-na'],
    },
...
function getIconCode(iconName, providerId, partOfDay) {
    ...
    if (providerId === 'om') {
        iconCodeParts = WeatherFont.iconNameByOmCode[iconName]
